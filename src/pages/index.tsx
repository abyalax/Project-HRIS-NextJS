  ...
  return (
    <div
      className={`${geistSans.variable} ${geistMono.variable} 
        grid grid-rows-[20px_1fr_20px] bg-[#333333] items-center justify-items-center min-h-screen px-8 pt-0 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]`}>
      ...
      <nav className="fixed bg-[#fefefe] top-4 my-7 flex gap-16 justify-between shadow-2xl py-6 px-8 rounded-full">
        ...
        <div className="flex gap-6 items-end justify-end">
          <button onClick={() => push('/auth/login')}
            className="rounded-full font-semibold bg-[#191919] text-white  text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5"
          >
            Login
          </button>
      ...
      <footer className="row-start-3 flex gap-6 flex-wrap items-center justify-center">
        <h2 className="text-3xl text-white">This App is still Development</h2>
      </footer>
    </div>
  )
}
