        ...
        <DashboardAdminLayouts>
            <main className="p-2">
                <div className="flex justify-between items-center">
                    <h2 className="text-2xl ml-2 font-semibold">Requests</h2>
                ...
                <div className="bg-white border-2 border-slate-200 h-fit rounded-xl m-1 mb-96">
                    <table className="w-full  rounded-xl">
                        ...
                        <tbody>
                            {dataRequest.slice(0, 6).map((data, index) => (
                                <tr key={data.period.toString() + data.type}>
                                    ...
                                    <td className="px-3 py-3">{data.type}</td>
                                        ...
                                        <div className="relative">
                                            ...
                                            <Dropdown ID={`action-${index}`} custom="right-4 top-2">
                                                <div className="flex gap-2 flex-col p-2 rounded-lg border-2 border-slate-300 drop-shadow-2xl">
                                                    ...
                                                    <button className="px-2.5 py-1.5 bg-green-600 flex items-center justify-center rounded text-white text-sm">Approve</button>
                                                    <button className="px-2.5 py-1.5 bg-red-500 flex items-center justify-center rounded text-white text-sm">Reject</button>
