...
const AdminDashboard = () => {
    ...
    return (
        <DashboardAdminLayouts>
            ...
            <div className="border-2 bg-white border-slate-200 h-12 p-2 w-1/4 my-2 rounded-lg absolute right-4 top-0">
                <p>pencarian</p>
            </div>
            ...
            <div className="w-full">
                ...
                <div className="flex justify-between gap-5">
                    ...
                    <div className="border-2 bg-white border-slate-200 h-14 w-1/4 my-2 rounded-lg p-2">
                        <p>profile admin</p>
                    </div>
                </div>
